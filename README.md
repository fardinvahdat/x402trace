...
- **v0.3.2.1** (current, 2026-05-27) — fast-follow: TateLyman body-discovery copy fix + Bazaar contributor handbook section, TKCollective AgentOracle captured-response fixture (hybrid D.3 + D.5), Giveth funding rail, paid-audits README section, [ADR-007](./DECISIONS.md) drafted for v0.3.3 K (payment-payload echo gap diagnose rules). No verdict-output changes; JSON API contract preserved verbatim.
- **v0.3.3 scope locked 2026-05-27** — three diagnose-rule additions filed: K (payment-payload echo gap, [X402-50](https://vahdatfardin.atlassian.net/browse/X402-50)) + G (facilitator-fitness for non-CDP rails, [X402-51](https://vahdatfardin.atlassian.net/browse/X402-51)) + I (`service_unreachable` verdict, [X402-52](https://vahdatfardin.atlassian.net/browse/X402-52)). All three are 2-voice promotions. TomSmart cdp-mature wire-up + 4 other contributor fixtures fold into this cycle as they arrive.
