...
- **Phase:** v0.3.1 shipped 2026-05-20 ([`x402trace@0.3.1`](https://www.npmjs.com/package/x402trace) — hotfix carrying two external-contributor PRs: [#66](https://github.com/fardinvahdat/x402trace/pull/66) v2 challenge body parsing by @hypeprinter007-stack, [#67](https://github.com/fardinvahdat/x402trace/pull/67) `bazaar-check` HTTP probe timeouts by @peterxing). **Now in v0.3.2 implementation:** scope locked + 8 Jira tickets filed 2026-05-21 ([X402-41](https://vahdatfardin.atlassian.net/browse/X402-41) ADR-004 → [X402-48](https://vahdatfardin.atlassian.net/browse/X402-48) release cut), with 10 Blocks dependency links wired. **Fixture-freeze gate:** TomSmart_ai cdp-mature drop in #show-and-tell on 2026-05-24 (~07:00 UTC); provisional v0.3.2 tag-push **2026-05-26**. Separately: [X402-40](https://vahdatfardin.atlassian.net/browse/X402-40) tracks the Node 22 `npx` ESM-resolver hang (Solana-dep drop branch **shelved** after 2-voice convergence — hypeprinter007's anchor-x402 Solana rail + TomSmart's x402-fetch transitive diagnostic; README workaround ships unconditionally in v0.3.2).
